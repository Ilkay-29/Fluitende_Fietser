...
document.getElementById("verstuurbtn").addEventListener("click", function() {
    let naam = document.getElementById("naam2").value.trim();
    let telefoon = document.getElementById("telefoon2").value.trim();
    let email = document.getElementById("email2").value.trim();
    let onderwerp = document.getElementById("onderwerp2").value.trim();
    let vraag = document.getElementById("vraag2").value.trim();

    if (naam === "" || telefoon === "" || email === "" || onderwerp === "" || vraag === "")  {
        alert("U heeft nog niet alles ingevuld");
        
    } else {
        alert("Je fiets is besteld!");
    }
});